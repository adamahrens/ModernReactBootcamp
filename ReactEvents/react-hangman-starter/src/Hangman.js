...
class Hangman extends Component {
  ...
  */
  ...
  /** reset the state of the game. Picks a random word
   * 
   */
  reset() {
  ...
  /** render: render game */
  render() {
    let didLose = this.state.nWrong >= this.props.maxWrong

    var display
    if (didLose) {
      display = <p className="Hangman-wrong">Game Over! The correct answer was {this.state.answer}</p>
    } else {
      display = <p className="Hangman-wrong">Number wrong {this.state.nWrong} of {this.props.maxWrong}</p>
    }
